...
#  DISCLAIMER: I COMPLETELY MODIFIED HINTS TO TEST MY CODE                                                                


# PROGRAMMER: Nazli Guleryuz
# DATE CREATED:                                  
# REVISED DATE: 
...
def get_pet_labels(image_dir):
    ...
    for idx in range(0, len(in_files), 1):
       ...
       if in_files[idx][0] != ".":#Skips file if starts with . (like .DS_Store of Mac OSX) cuz it isn't an pet image 
            word_list=in_files.lower().split("_")
