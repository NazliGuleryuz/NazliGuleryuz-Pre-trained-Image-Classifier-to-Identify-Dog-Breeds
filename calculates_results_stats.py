...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:# process through the results dictionary
        
        if results_dic[key][2] == 1:# Labels Match Exactly
            results_stats_dic['n_match'] += 1
        #dog and breeds match
        if results_dic[key][2] == 1 and results_dic[key][3] == 1:
            results_stats_dic['n_correct_breed'] += 1#counts pet images of dogs w their breed               correctly classified
        ...
        #how many images that arent dogs correctly classified
        else:
    ...
    results_stats_dic['n_images'] = len(results_dic)# calculates number of total images
    ...
    #correctly matched images ('n_match') divided by the number of images('n_images')
    results_stats_dic['pct_match'] = (results_stats_dic['n_match']/results_stats_dic['n_images']) * 100
    # Calculates % correct dogs
    #number of correctly classified dog images('n_correct_dogs')/ the number of dog images('n_dogs_img')
    results_stats_dic['pct_correct_dogs'] = (results_stats_dic['n_correct_dogs']/results_stats_dic['n_dogs_img']) * 100     
    # Calculates % correct breed of dog
    #number of correctly classified breeds of dog('n_correct_breed') divided by the number of dog images('n_dogs_img').
